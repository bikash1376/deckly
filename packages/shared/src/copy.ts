 ...
 *
 * It lives in the shared package because it has to run twice: once in the
 * Worker before generated content is written to the database, and once in the
 * app before anything is rendered. Two copies of this logic would drift, and
 * the drift would show up as punctuation nobody can explain.
 */
